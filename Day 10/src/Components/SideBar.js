                      ...
                      <>
                        {userType === "student" ? (
                          <>
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'Dashboard' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                            ...
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'Courses' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                              component={<Link to="/courses" />}
                              icon={<LibraryBooksIcon />}
                            ...
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'grades' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                            ...
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'activities' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                            ...
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'attendance' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                          ...
                          <>
                            ...
                            <MenuItem
                              style={{
                                backgroundColor: activeMenuItem === 'Students' ? 'white' : 'transparent',
                                borderRadius: 50
                              }}
                              component={<Link to="/students" />}
                              icon={<BadgeIcon />}
