      ...
      <div className="head">
        ...
        {userType === 'ADMIN' && (
          <>
            ...
            {isOpen && (
              <div className="popup">
                <h3 className='cent'>{editingCourse ? 'EDIT A COURSE' : 'ADD A COURSE'}</h3>
                <input
                  type="text"
                  className="course-title covi"
