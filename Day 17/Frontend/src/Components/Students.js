    ...
    <div className="students-container">
      ...
      {isOpen && (
        <div className="popup1">
          <h3 class="headv">{editMode ? 'EDIT STUDENT' : 'ADD A STUDENT'}</h3>
          <input
            type="text"
            className="student-name covin"
          ...
          <div class="gender-div">&nbsp;
           <select
            className="student-gender covin1"
          ...
          <input
            type="text"
            className="student-contactnum covin"
          ...
          <input
            type="text"
            className="student-address covin"
            placeholder="Address"
          ...
          <input
            type="number"
            className="student-feePaid covin"
