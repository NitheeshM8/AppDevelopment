    ...
    <div class="border1"></div> 
      <ul>
       ...
       <li class="con" onClick={togglePopup}>Contact  </li>
        {isOpen && <ContactForm
          content={<>
            <b className='cont-v'>CONTACT FORM</b>
            <input type="text1" placeholder="Email"/>
            <input type="text1" placeholder="Name"/>
            <input type="text1" id="message" placeholder="Enter Your Message"/>
