...
function Privacy() {
  return (
    <div class="privacy-container"><h2>Privacy Policy of <span class="website_url">www.learnneo.com</span></h2>

    <p>At <span class="website_name">LEARNNEO STUDENT PORTAL</span>, we collect and manage user data according to the following Privacy Policy.</p>
